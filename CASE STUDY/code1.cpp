...
void create() {
    ...
    printf("\n\t================================\n");
        ...
        fprintf(fptr, "\n\t    %15s\t%15s\t%15s\t%15s\t%15s\t%15s\t%15s\n", "Employee Number", "Employee Name", "Status Code", "Basic Salary", "Overtime Hours", "Deductions", "Net Pay");
    ...
    for (i = 0; i < number; i++) {
        ...
        fprintf(fptr, "\n\t    %15s\t%15s\t%15s\t%15.2lf\t%15.2lf\t%15.2lf\t%15.2lf", emprec[i].empnum, emprec[i].empname, emprec[i].statcode, emprec[i].bsalary, emprec[i].othours, emprec[i].deduc, emprec[i].netpay);
    }
