...
void create() {
    ...
    for (i = 0; i < number; i++) {
        ...
        fprintf(fptr, "\n\t%13s\t%17s\t%12s\t%12.2lf\t%10.2lf\t%13.2lf\t%15.2lf", emprec[i].empnum, emprec[i].empname, emprec[i].statcode, emprec[i].bsalary, emprec[i].otpay, emprec[i].deduc, emprec[i].netpay);
    }
